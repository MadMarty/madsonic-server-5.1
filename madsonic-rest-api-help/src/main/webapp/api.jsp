...
<p>
    The Madsonic API allows anyone to build their own programs using Madsonic as the media server, 
	whether they're on the web, the desktop or on mobile devices. 
</p>

<h2 class="div">Introduction</h2>

<p>
    The Madsonic API allows you to call methods that respond in <a href="http://en.wikipedia.org/wiki/Representational_State_Transfer">REST</a> style xml.
...
<table width="100%" class="bottomspace">
    ...
    <tr class="table-altrow">
        ...
        <td>The protocol version implemented by the client, i.e., the version of the
            <code>madsonic-rest-api.xsd</code> schema used (see below).</td>
    </tr>
    <tr>
        <td><code>c</code></td>
        <td>Yes</td>
...
<table width="100%" class="bottomspace">
    ...
    <tr class="table-altrow">
        <td><code>20</code></td>
        <td>Incompatible Madsonic REST protocol version. Client must upgrade.</td>
    </tr>
    <tr>
        <td><code>30</code></td>
        <td>Incompatible Madsonic REST protocol version. Server must upgrade.</td>
    </tr>
    <tr class="table-altrow">
        <td><code>40</code></td>
    ...
    <tr class="table-altrow">
        <td><code>60</code></td>
        <td>The trial period for the Madsonic server is over. Please upgrade to Madsonic Premium. Visit subsonic.org for details.</td>
    </tr>
    <tr>
        <td><code>70</code></td>
...
<table width="50%" class="bottomspace">
    <tr>
        <th class="param-heading">Madsonic version</th>
        <th class="param-heading">REST API version</th>
    </tr>
	    <tr class="table-altrow">
        <td>5.1</td>
        <td><a href="http://sourceforge.net/p/subsonic/code/HEAD/tree/tags/release-4.9/subsonic-main/src/main/webapp/xsd/subsonic-rest-api.xsd">1.12.0</a></td>
    </tr>
    <tr class="table-altrow">
        <td>5.0</td>
        <td><a href="http://sourceforge.net/p/subsonic/code/HEAD/tree/tags/release-4.9/subsonic-main/src/main/webapp/xsd/subsonic-rest-api.xsd">1.10.5</a></td>
    </tr>
    <tr class="table-altrow">
        <td>4.9</td>
...
<p>
    Note that a Madsonic server is backward compatible with a REST client if and only if the major version is the same,
