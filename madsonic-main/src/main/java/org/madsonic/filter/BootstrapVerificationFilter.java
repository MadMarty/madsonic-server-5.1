 ...
 * the Madsonic home directory (c:\madsonic or /var/madsonic) exists and
 * is writable. If not, a proper error message is given to the user.
 * <p/>
 * (The Madsonic home directory is usually created automatically, but a common
...
public class BootstrapVerificationFilter implements Filter {
    ...
    private boolean madsonicHomeVerified = false;
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        if (!directoryExists(home)) {
            error(res, "<p>The directory <b>" + home + "</b> does not exist. Please create it and make it writable, " +
                       ...
                       "<p>(You can override the directory location by specifying -Dmadsonic.home=... when " +
