...
public class PodcastDao extends AbstractDao {
    ...
    private static final int[] CHANNEL_DATATYPES = {Types.INTEGER, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR };
    private static final int[] EPISODE_DATATYPES = {Types.INTEGER, Types.VARCHAR,Types.VARCHAR,Types.VARCHAR,Types.VARCHAR,Types.VARCHAR,Types.TIMESTAMP,
    ...
    public synchronized int createChannel(PodcastChannel channel) {
        ...
        secureupdate(sql, CHANNEL_DATATYPES, null, channel.getUrl(), channel.getTitle(), channel.getDescription(),
    ...
    public void createEpisode(PodcastEpisode episode) {
        ...
        secureupdate(sql, EPISODE_DATATYPES, null, episode.getChannelId(), episode.getUrl(), episode.getPath(),
