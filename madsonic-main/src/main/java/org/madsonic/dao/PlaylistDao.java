...
public class PlaylistDao extends AbstractDao {
    ...
    public List<Playlist> getReadablePlaylistsForUser(String username, String sortCriteria) {
		...
		// sortCriteria = name (ASC), created (DESC), changed (DESC)
    	
//    	String sortCriteriaName = "name asc";
//    	String sortCriteriaCreated = "created desc";
//    	String sortCriteriaChanged = "changed desc";    	
    	
        List<Playlist> result1 = getWritablePlaylistsForUser(username, sortCriteria);
        List<Playlist> result2 = query("select " + COLUMNS + " from playlist where is_public order by " + sortCriteria, rowMapper);
    ...
    public List<Playlist> getWritablePlaylistsForUser(String username, String sortCriteria) {
        return query("select " + COLUMNS + " from playlist where username=? order by " + sortCriteria, rowMapper, username);
    }
    ...
    public List<Playlist> getAllPlaylists(String sortCriteria) {
        return query("select " + COLUMNS + " from playlist order by " + sortCriteria, rowMapper);
    }
