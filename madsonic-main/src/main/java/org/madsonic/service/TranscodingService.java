...
import org.madsonic.controller.VideoPlayerController;
...
import org.madsonic.io.TranscodeInputStream;
...
//            }
    ...
    public File getTranscodeDirectory() {
        File dir = new File(SettingsService.getMadsonicHome(), "transcode");
        if (!dir.exists()) {
