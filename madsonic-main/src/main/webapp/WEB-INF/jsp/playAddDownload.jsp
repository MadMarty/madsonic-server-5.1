    ...
    <a href="#" onclick="toggleStar(${param.id}, '#starImage${param.id}'); return false;">
        <c:choose>
            <c:when test="${param.starred}">
                <img class="controls" id="starImage${param.id}" src="<spring:theme code="ratingOnImage"/>" alt="">
            </c:when>
            <c:otherwise>
                <img class="controls" id="starImage${param.id}" src="<spring:theme code="ratingOffImage"/>" alt="">
            </c:otherwise>
        </c:choose>
    </a>
<c:if test="${param.asTable}"></td></c:if>
    ...
    <c:choose>
        <c:when test="${param.video}">
            ...
            <a href="#" onclick="window.open('${videoUrl}', parent.playQueue.CastPlayer.receiverFound ? '_blank' : 'main'); return false;">
                <img class="controls" src="<spring:theme code="playImage"/>" alt="<fmt:message key="common.play"/>"
		...
		<c:if test="${param.asTable}"><td></c:if>
			...
			<img class="controls" src="<spring:theme code="playImage"/>" alt="<fmt:message key="common.play"/>" title="<fmt:message key="common.play"/>"></a>
		<c:if test="${param.asTable}"></td></c:if>		
		
		<c:if test="${param.playAddEnabled}">
		<c:if test="${param.asTable}"><td></c:if>
		<a href="javascript:void(0)" onclick="parent.playQueue.onPlayAdd('${param.id}');">
			<img class="controls" src="<spring:theme code="playAddImage"/>" alt="<fmt:message key="common.playadd"/>" title="<fmt:message key="common.playadd"/>"></a>
		<c:if test="${param.asTable}"></td></c:if>
		</c:if>
...
<c:if test="${param.asTable}"><td></c:if>
    <a href="javascript:void(0)"><img class="controls" id="add${param.id}" src="<spring:theme code="addImage"/>" alt="<fmt:message key="common.add"/>" title="<fmt:message key="common.add"/>"></a>
<c:if test="${param.asTable}"></td></c:if>
</c:if>
...
<c:if test="${param.asTable}"><td></c:if>
		...
		<img class="controls" src="<spring:theme code="addImage"/>" alt="<fmt:message key="common.addnext"/>" title="<fmt:message key="common.addnext"/>"></a>
<c:if test="${param.asTable}"></td></c:if>
</c:if>
...
<c:if test="${param.asTable}"><td></c:if>
    ...
    <img class="controls" src="<spring:theme code="addImage"/>" alt="<fmt:message key="common.addlast"/>" title="<fmt:message key="common.addlast"/>"></a>
<c:if test="${param.asTable}"></td></c:if>
</c:if>
...
<c:if test="${param.asTable}"><td></c:if>
    <a href="${downloadUrl}">
        <img class="controls" src="<spring:theme code="downloadImage"/>" alt="<fmt:message key="common.download"/>"
...
<c:if test="${model.dir.album}">
	<c:if test="${param.asTable}"><td></c:if>
		...
		<img class="controls" src="<spring:theme code="youtubeImage"/>" alt="YouTube" title="YouTube"></a>
		<c:if test="${param.asTable}"></td></c:if>
		</c:if>
</c:if>
