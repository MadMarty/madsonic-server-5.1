...
<c:if test="${param.asTable}"><td></c:if>
    <a href="#"><img class="controls" id="add${param.id}" src="<spring:theme code="addImage"/>" alt="<fmt:message key="common.add"/>" title="<fmt:message key="common.add"/>"></a>
<c:if test="${param.asTable}"></td></c:if>
</c:if>
...
<c:if test="${param.downloadEnabled}">
    ...
    <a href="${downloadUrl}">
        <img class="controls" src="<spring:theme code="downloadImage"/>" alt="<fmt:message key="common.download"/>" title="<fmt:message key="common.download"/>"></a>
</c:if>
<c:if test="${param.asTable}"></td></c:if>
