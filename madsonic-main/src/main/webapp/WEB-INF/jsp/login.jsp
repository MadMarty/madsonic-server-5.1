	...
	<center>
		<div class="centered">
			<form action="<c:url value="/j_spring_security_check"/>" method="POST">
					<div class="loginsplash bgcolor2" align="center" style="min-width:220px;max-width:500px;border:1px solid black; padding:20px 50px 20px 50px; margin-top:200px">
					...
					<td align="left" style="padding-bottom:10px"><input type="password" id="j_password" name="j_password" style="width:12em" tabindex="2"></td>
					</tr>
					<tr>
					...
					<b class="warning" style="margin-top: 10px;"><fmt:message key="login.error"/></b>
					</td></tr>
					</c:if>
					</table>
