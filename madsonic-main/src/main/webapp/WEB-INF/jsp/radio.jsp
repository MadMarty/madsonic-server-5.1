...
span.off:hover {
	...
	function playGenreRadio() {
		...
		var numplaycount = document.getElementsByName("GenreRadioPlayCount")[0].selectedIndex;
		var playcount = document.getElementsByName("GenreRadioPlayCount")[0].options[numplaycount].text;

		var numyear = document.getElementsByName("GenreRadioYear")[0].selectedIndex;
		var genreyear = document.getElementsByName("GenreRadioYear")[0].options[numyear].value;
		
		parent.playQueue.onPlayGenreRadio(genres, playcount, genreyear);
	}
	</script>
</head>
