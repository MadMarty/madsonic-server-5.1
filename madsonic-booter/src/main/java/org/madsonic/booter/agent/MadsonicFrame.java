...
public class MadsonicFrame extends JFrame {
	...
	private static final long serialVersionUID = 6205367374747790612L;
    ...
    public MadsonicFrame(MadsonicAgent madsonicAgent, StatusPanel statusPanel, SettingsPanel settingsPanel) {
    ...
    public void setVisible(boolean b) {
        super.setVisible(b);
        madsonicAgent.setServiceStatusPollingEnabled(b);
    }
